...
- smoke ile uretilen kitlerde verify ayrica:
  ...
  - `pilot-smoke-live.md` raporu `pilot-smoke-live.json` ile, metadata, karar satirlari ve check tablosu, satir sirasi ve beklenmeyen ekstra satirlar dahil, birebir uyusuyor mu
