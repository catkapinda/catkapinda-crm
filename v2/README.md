...
- eger kit smoke ile uretildiyse verify artik:
  ...
  - `pilot-smoke-live.md` raporunun `pilot-smoke-live.json` ile, metadata, baslik/yapi satirlari, karar satirlari ve check tablosu, satir sirasi, beklenmeyen/tekrarlanan tablo satirlari, stale summary bullet'lari ve beklenmeyen yapi satirlari dahil, birebir uyumlu kalip kalmadigini
