...
- eger kit smoke ile uretildiyse verify artik:
  ...
  - `pilot-smoke-live.md` raporunun `pilot-smoke-live.json` ile, metadata, baslik/yapi satirlari, karar satirlari ve check tablosu, satir sirasi, beklenmeyen/tekrarlanan tablo satirlari ve stale summary bullet'lari dahil, birebir uyumlu kalip kalmadigini
