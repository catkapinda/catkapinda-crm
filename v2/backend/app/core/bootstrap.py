...
AUTH_BOOTSTRAP_STATEMENTS: tuple[str, ...] = (
    ...
    "ALTER TABLE personnel ADD COLUMN IF NOT EXISTS accounting_type TEXT DEFAULT 'Kendi Muhasebecisi'",
    "ALTER TABLE personnel ADD COLUMN IF NOT EXISTS new_company_setup TEXT DEFAULT 'Hayır'",
    "ALTER TABLE personnel ADD COLUMN IF NOT EXISTS exit_date DATE",
    "ALTER TABLE personnel ADD COLUMN IF NOT EXISTS accounting_revenue NUMERIC NOT NULL DEFAULT 0",
...
LOCAL_SQLITE_DOMAIN_ALTERATIONS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "personnel": (
        ...
        ("accounting_type", "ALTER TABLE personnel ADD COLUMN accounting_type TEXT DEFAULT 'Kendi Muhasebecisi'"),
        ("new_company_setup", "ALTER TABLE personnel ADD COLUMN new_company_setup TEXT DEFAULT 'Hayır'"),
        ("exit_date", "ALTER TABLE personnel ADD COLUMN exit_date TEXT"),
        ("accounting_revenue", "ALTER TABLE personnel ADD COLUMN accounting_revenue REAL DEFAULT 0"),
