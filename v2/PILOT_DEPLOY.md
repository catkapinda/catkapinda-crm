...
- smoke ile uretilen kitlerde verify ayrica:
  ...
  - `pilot-smoke-live.md` raporu `pilot-smoke-live.json` ile, metadata, baslik/yapi satirlari, karar satirlari ve check tablosu, satir sirasi, beklenmeyen/tekrarlanan tablo satirlari, stale summary bullet'lari, beklenmeyen yapi satirlari ve serbest stale satirlar dahil, birebir uyusuyor mu
