...
- eger kit smoke ile uretildiyse verify artik:
  ...
  - `pilot-smoke-live.md` raporunun `pilot-smoke-live.json` ile, metadata, karar satirlari ve check tablosu, satir sirasi, beklenmeyen ekstra satirlar ve tekrarlanan satirlar dahil, birebir uyumlu kalip kalmadigini
