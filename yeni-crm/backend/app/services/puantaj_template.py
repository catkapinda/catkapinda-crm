...
def generate_puantaj_template(
    ...
    guide_lines = [
        ...
        "",
        "TİP KODLARI:",
        "  D = DESTEK — ücretli (Kurye, Restoran Takım Şefi veya Kaptan",
        "      başka restorana gitti)",
        "      → KİŞİYE paket × tarife + saat × tarife EKSTRA hakediş yansır",
        "      → RESTORANA aynı tutar fatura yansır",
        "  Y = YÖNETİM — ücretsiz (Bölge Müdürü veya Joker gitti)",
        "      → KİŞİYE ekstra ücret YOK (sabit aylık zaten yeterli)",
        "      → RESTORANA paket × tarife faturası YANSIR",
        "",
        "  NOT: Sistem hakedişi her zaman KİŞİNİN ROLÜNE göre hesaplar:",
        "       BM / Joker → ekstra yok · Kurye / RTŞ / Kaptan → ekstra var.",
        "       (Yanlış kod yazsanız bile rol bazlı doğru hesaplanır.)",
        "",
